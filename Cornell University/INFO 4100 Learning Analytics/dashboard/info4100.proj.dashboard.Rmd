...
* For whom? Who will use it and what is their background?
    ...
    + Business Intelligence class students in 2016-2018
    
* Why? What is the goal? What questions to answer?
    + How can this student improve their performance?
    + Where does this student lack in prior experience?
    + Where does this student fall in terms of performance and engagement?
    + How much experience does this student have already?

* What? What data to show and what is its structure?
    + Engagement: # of clickers completed, attendance, 
    + Performance: # of clickers answered correctly, temperature clicker level, quiz score
    + Experience: different self-reported scores
        
* How? How will visualizations support the goal?
    + Visualize a student's engagement and where they stand when compared to overall engagement
    + Visualize a student's performance and where they stand when compared to overall performance
    + Visualize areas with prior experience
    
*Planning for the teacher dashboard*

* For whom? Who will use it and what is their background?
    + Business Intelligence Professor at Cornell
    + Can be used by other professors teaching classes for grad + undergrads with similar course content and student backgrounds
    
* Why? What is the goal? What questions to answer?
    + Have an understanding of students overall performance and engagement
    + See what underlying factors influence performance and engagement and improve teaching methods accordingly
    + How engaged are students in this course who have prior experience vs.those who don't?
    + How well do students in this course perform who have prior experience vs.those who don't?
    + What types of prior experience help students perform well in this course?
...
* How? How will visualizations support the goal?
    + Visualize what skills most students in the class tend to have
    + Visualize each type of experience vs. performance level to see if any of them have a strong correlation
    + Visualize engagement vs. performance
    + Visualize differences in undergraduate vs. graduate in performance and engagement
...
nice_data$YEAR = paste0('@', nice_data$YEAR)
...
avg_quiz_graph = ggplot(attendance_rate, aes(x=SESSION_NUMBER, y=attendance_per_session, group=YEAR, color=YEAR)) +
  labs(y = "Attendance Rate", x = "Session Number") +
  scale_x_continuous(n.breaks=26) +
  geom_line()

attendance_rate_graph = ggplot(avg_quiz_data, aes(fill=PROG, y=avg_quiz_score, x=YEAR)) +
